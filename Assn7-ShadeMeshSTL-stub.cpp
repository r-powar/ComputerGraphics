...
char *filename = "C:\\Users\\Raj\\Desktop\\Graphics\\Assignment1\\MarsTharsisRegion6xv.stl";
...
void Display() {
	...
	GLSL::VertexAttribPointer(program, "normal", 3, GL_FLOAT, GL_FALSE, sizeof(VertexSTL), (void *)(2 * sizeof(vec3)));
